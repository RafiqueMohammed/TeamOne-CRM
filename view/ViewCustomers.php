...
<div class="row">
    ...
    <?php require_once(INC_DIR."breadcrumb.php"); ?>
        ...
        <div class="page-header">
            ...
            <h1>Customers <small>Information</small></h1>
...
?>
    		...
    		<table class="table table-condensed table-striped table-bordered table-hover table-full-width" id="ViewCustomerDataTable">
    			<thead>
                    <tr>
