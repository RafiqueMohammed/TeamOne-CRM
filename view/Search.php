...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <div class="page-header">
            ...
            <h1>Search <small>Customer Information</small></h1>
        ...
        <div class="search-classic">
            <form action="#" class="form-inline">
                <div class="input-group well">
                    <input type="text" class="form-control" id="customer_search_box" value="<?php if(isset($keyword)){ echo $keyword;}?>" placeholder="Search...">
            ...
            <h3 class="search-keyword"><?php if(isset($keyword)){ echo "Search for \"{$keyword}\"";}?> </h3>
            <hr>
