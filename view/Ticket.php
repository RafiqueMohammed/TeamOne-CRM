    ...
    foreach ($json_content['data'] as $data => $val) {
        ...
        switch ($type) {
            case 'installation':
                ...
                if ($val['assignment_info']['install_type'] == "n") {
                    $val['assignment_info']['install_type'] = "Non-standard";
                } else if ($val['assignment_info']['install_type'] == "s") {
                    $val['assignment_info']['install_type'] = "Standard";
                } else if ($val['assignment_info']['install_type'] == "f") {
                    $val['assignment_info']['install_type'] = "Free";
                }
            ...
            <td>" . $val['type'] . " <i class='clip-popout cursor big_icon' onclick='show_popup(\"row_" . $i . "\",\"service_popup\")'></i>" . $service_info . "</td><td class='re_date'>" . ConvertToIST($val['assign_date']) . "</td>
...
<div class="row">
    <div class=" col-md-12">
        ...
        <div class="table-responsive">
            <table
                class="table table-striped table-bordered table-hover table-condensed table-full-width" <?php if (!$isEmpty) {
                echo "id='TicketDataTable'";
            } ?>>
                <thead>
                <tr>
