            ...
            <table id="table1" class="table table-striped table-bordered ">
                ...
                <tr>
                    ...
                    <td class="col-sm-4">
                        ...
                        <label class="radio-inline"> <input type="radio" class="green acc_type" name="acc_type"
                                                            checked="checked" value="r">Residential
                        </label>
                        <label class="radio-inline"> <input type="radio" class="green acc_type" name="acc_type"
                                                            value="c">Commercial
                        </label>
...
<input type="text" id="registration_mobile2" class="form-control" maxlength="10"
       name="mobile2" placeholder="Mobile Number" onkeypress="return isNumber(event)"/><i
                                class=" clip-mobile "></i></span>
                        <span class="error_span"></span>
                    </td>
...
<span class="input-icon">
    ...
    <i class="fa fa-location-arrow"></i>
                        ...
                        <div id="pincode_display"
                             style="position: absolute; z-index: 10; display: table; width: 27.5%;"></div>
                    ...
                    <td>
        <span class="input-icon">
        <input type="text" id="registration_city" class="form-control req" name="city" value="Mumbai"
               placeholder="City"/>
        ...
        <select id="registration_landmark" class="form-control req" name="landmark">
            <option value="-1"> - Not Available -</option>
                    ...
                    <td>
        <span class="input-icon">
        <input type="text" id="registration_location" class="form-control req" name="location"
        ...
        <i class="clip-map "></i>
                ...
                <tr>
                    ...
                    <td class="col-sm-4">
                        <label class="radio-inline"> <input type="radio" class="green" name="communication_type" checked
                                                            value="m">Mobile
                        </label>
                        <label class="radio-inline"> <input type="radio" class="green" name="communication_type"
                                                            value="e">Email
                        </label>
                        <label class="radio-inline"> <input type="radio" class="green" name="communication_type"
                                                            value="b">Both
       ...
       <span class="col-sm-6"> <input style="display: none;" name="referred_other" placeholder="Specify Other"
                                      id="registration_referred_other" class="form-control oth_show"/>
 </span>
                        <span class="error_span"></span>
                    </td>
...
<span class="input-icon">
        ...
        <i class="clip-calendar"></i>
                    ...
                    <td><span class="input-icon"><textarea class="form-control" name="remarks"
                                                           id="registration_remarks"></textarea>
    </span>
                    </td>
    ...
    <div class="col-sm-12 table-responsive">
        ...
        <form id="customer_ac_form" name="form2">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td colspan="4" style="text-align: center;">
                        <input type="button" class="btn btn-primary" name="submit" id="customer_ac_details_submit"
                               value="Submit"/>

                        <a class="pull-right btn btn-info" onclick="add_customer_ac_row()"
                           style="cursor: pointer; border-radius:100%">+</a>
                    </td>
                </tr>
