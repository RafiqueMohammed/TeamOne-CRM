            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tr class='aaa row_1'>
                        ...
                        <td class="center col-md-1"><input type="number" class="form-control" placeholder="Dry"
                                                           size="1"> <br>
                        ...
                        <td class="" style='color: brown'><i onclick='remove_amc_row(1);'
                                                             class='clip-minus-circle-2'></i></td>
                    </tr>
                    </tbody>
                    <tfoot class="table_foot">
                    <tr>
                        <td colspan="8">
                            <div class="pull-right btn btn-danger add_btn"><i class="fa fa-plus"></i></div>
                        </td>
                    </tr>
            ...
            <div class="row-fluid">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <td colspan="2"><select onchange="onUninstallACSelect()"
                                                    class="select_uninstalled_ac form-control">
                                    <option value=""> -- Select AC --</option>
                                </select>
                                <br/>
                                <input type="hidden" class="select_ac_id" value="-1">

                                <div class="display_ac_info">
                                    <table class="table table-bordered">
                                        <tr>
                                            <th>AC Type</th>
                                            <td class="display_ac_info_type"> --N/A--</td>
                                            <th>Make</th>
                                            <td class="display_ac_info_make"> --N/A--</td>
                                        </tr>
                                        <tr>
                                            <th>Place</th>
                                            <td class="display_ac_info_place"> --N/A--</td>
                                            <th>Tonnage / HP</th>
                                            <td class="display_ac_info_tonnage"> --N/A--</td>
                                        </tr>
                                        <tr>
                                            <th>IDU Serial No.</th>
                                            <td class="display_ac_info_idu_sr"> --N/A--</td>
                                            <th>ODU Serial No.</th>
                                            <td class="display_ac_info_odu_sr"> --N/A--</td>
                                        </tr>
                                        <tr>
                                            <th>IDU Model No.</th>
                                            <td class="display_ac_info_idu_md"> --N/A--</td>
                                            <th>ODU Model No.</th>
                                            <td class="display_ac_info_odu_md"> --N/A--</td>
                                        </tr>
                                    </table>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input data-date-viewmode="years" placeholder="dd-mm-yyyy" data-date-format="dd-mm-yyyy"
                                       type="text" class="date-picker form-control installation_date"/></td>
                        </tr>
                        <tr>
                            <th>Remarks</th>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control preffered_date" data-date-format="dd-mm-yyyy"
                                       data-date-viewmode="years"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" class="center display_output">
                                <div></div>
                            </td>
                        </tr>
                    </table>
        ...
        <div class="modal-body">
            ...
            <table class="table table-bordered add_ac_table">
                ...
                <tr>
                    ...
                    <td><input type="text" placeholder="IDU model number"
                               class="form-control add_cust_ac_idu_model_no"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" placeholder="ODU model number"
                               class="form-control add_cust_ac_odu_model_no"/></td>
                </tr>
                <tr>
                    <th>Remarks</th>
...
<div id="modal_add_tech" style="display: none;">
    <div style="background-color: #fff; border-radius: 5px;">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" onclick="reset_form('#add_technicians_box')"
                    aria-hidden="true">
                &times;
            </button>
                ...
                <div class="col-md-12">
                    ...
                    <form id="add_technicians_box">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>
                                    <label>Mobile<span style="color: red;">&nbsp;*</span></label><span
                                        class="mob_error"></span>
                                    <input placeholder="Ex: 9820098200" maxlength="10" class="form-control tech_req"
                                           name="tech_mobile" onkeypress="return isNumber(event)"/>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <textarea placeholder="Address" class="form-control tech_req"
                                              name="tech_address"></textarea>
                                </td>
                                <td>
                    ...
                    <form id="edit_technicians_box">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>
                                    <label>First Name<span style="color: red;">&nbsp;*</span></label>
                                    <input placeholder="First name" class="form-control req_t display_tech_fname"
                                           id="fname_edit" name="fname"/>
                                </td>
                                <td>
                                    <label>Last Name<span style="color: red;">&nbsp;*</span></label>
                                    <input placeholder="Last name" class="form-control req_t display_tech_lname"
                                           id="lname_edit" name="lname"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>Mobile<span style="color: red;">&nbsp;*</span></label><span
                                        class="mob_error"></span>
                                    <input placeholder="Ex: 9820098200" maxlength="10"
                                           class="form-control req_t display_tech_mobile" id="mobile_edit" name="mob"
                                           onkeypress="return isNumber(event)"/>

                                </td>
                                <td>
                                    <label>Email</label>
                                    <input placeholder="Ex: abc@example.com" class="form-control display_tech_email"
                                           id="email_edit" name="mail"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>Address<span style="color: red;">&nbsp;*</span></label>
                                    <textarea placeholder="Address" class="form-control req_t display_tech_address"
                                              id="address_edit" name="add"></textarea>
                                </td>
                                <td>
                                    <label>Branch<span style="color: red;">&nbsp;*</span></label>
                                    <select class="form-control req_t display_tech_branch" id="branch_edit"
                                            name="branch">
                        ...
                        <table id="staff_form" class="table table-bordered">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input placeholder="Ex: 9820098200" maxlength="10" class="form-control staff_req"
                                           name="mobile" onkeypress="return isNumber(event)"/>
                            ...
                            <tr>
                                <td>
                                    <label>Address<span style="color: red;">&nbsp;*</span></label>
                                    <textarea placeholder="Address" class="form-control staff_req"
                    ...
                    <form id="staff">
                        <table id="staff_form" class="table table-bordered">
                            <tr>
                                <td>
                                    <label>First Name<span style="color: red;">&nbsp;*</span></label>
                                    <input placeholder="First name" class="form-control req_s edit_s_fname"
                                           id="up_staff_fname" name="fname"/>
                                </td>
                                <td>
                                    <label>Last Name<span style="color: red;">&nbsp;*</span></label>
                                    <input placeholder="Last name" class="form-control req_s edit_s_lname"
                                           id="up_staff_lname" name="lname"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>Mobile<span style="color: red;">&nbsp;*</span></label>
                                    <input placeholder="Ex: 9820098200" maxlength="10"
                                           class="form-control req_s edit_s_mobile" id="up_staff_mobile" name="mob"
                                           onkeypress="return isNumber(event)"/>
                                    <span class="error_span"></span>
                                </td>
                                <td>
                                    <label>Email</label>
                                    <input placeholder="Ex: abc@example.com" class="form-control edit_s_email"
                                           id="up_staff_email" name="mail"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>Address<span style="color: red;">&nbsp;*</span></label>
                                    <textarea placeholder="Address" class="form-control req_s edit_s_address"
                                              id="up_staff_address" name="add"></textarea>
                                </td>
                                <td>
                                    <label>Branch<span style="color: red;">&nbsp;*</span></label>
                                    <select class="form-control req_s edit_s_branch" id="up_staff_branch"
                                            name="staff_branch">
...
<div id="view_amc_modal" style="display: none;">
    <div style="background-color: #fff; border-radius: 5px; ">
        ...
        <div class="modal-footer">
            <br/>
            <button id='amc_assign_btn' class='btn btn-primary amc_assign_btn'><i class="fa fa-upload"></i> Update </button>
        </div>
    </div>
</div>
